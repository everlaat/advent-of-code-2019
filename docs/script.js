...
var $author$project$Lib$Input$Input = $elm$core$Basics$identity;
var $author$project$Lib$Input$fromString = $elm$core$Basics$identity;
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = _Utils_Tuple2(
	{
		P: $author$project$Lib$Input$fromString(''),
...
var $author$project$Lib$Solver$get = F2(
	function (key, _v0) {
		var dict = _v0;
...
var $author$project$Lib$Solver$run = F2(
	function (_v0, input) {
		var f = _v0;
		return f(input);
	});
var $author$project$Lib$Solver$Solvers = $elm$core$Basics$identity;
...
var $author$project$Lib$Solver$fromList = A2($elm$core$Basics$composeR, $elm$core$Dict$fromList, $elm$core$Basics$identity);
var $author$project$Solvers$Day01$Fuel = $elm$core$Basics$identity;
var $author$project$Solvers$Day01$calcFuel = function (_v0) {
	var mass = _v0;
	return A2($elm$core$Basics$max, 0, ((mass / 3) | 0) - 2);
};
var $elm$core$List$sum = function (numbers) {
	return A3($elm$core$List$foldl, $elm$core$Basics$add, 0, numbers);
};
var $author$project$Solvers$Day01$sumFuel = A2(
	...
	A2($elm$core$Basics$composeR, $elm$core$List$sum, $elm$core$Basics$identity));
var $author$project$Solvers$Day01$fuelRequired = A2(
	$elm$core$Basics$composeR,
	$elm$core$List$map($author$project$Solvers$Day01$calcFuel),
	$author$project$Solvers$Day01$sumFuel);
var $author$project$Solvers$Day01$fuelToString = function (_v0) {
	var a = _v0;
	return 'Fuel: ' + $elm$core$String$fromInt(a);
};
var $elm$core$String$lines = _String_lines;
var $author$project$Solvers$Day01$Mass = $elm$core$Basics$identity;
...
var $author$project$Solvers$Day01$massFromString = function (a) {
	return A2(
...
var $author$project$Lib$Input$toString = function (_v0) {
	var a = _v0;
	return a;
};
var $author$project$Solvers$Day01$inputToMassList = A2(
	$elm$core$Basics$composeR,
	...
	A2(
		...
		A2(
			$elm$core$Basics$composeR,
			$elm$core$List$map($author$project$Solvers$Day01$massFromString),
			A2(
				$elm$core$List$foldl,
				F2(
					function (resultMass, result) {
						var _v0 = _Utils_Tuple2(resultMass, result);
						if (_v0.b.$ === 1) {
							var err = _v0.b.a;
							return $elm$core$Result$Err(err);
						} else {
...
var $author$project$Lib$Solver$Solver = $elm$core$Basics$identity;
var $author$project$Lib$Solver$make = $elm$core$Basics$identity;
...
var $author$project$Solvers$Day01$partOne = _Utils_Tuple2(
	'Day 01, Part One',
...
var $author$project$Solvers$Day01$calcFuelInclusive = function (mass) {
	var _v0 = $author$project$Solvers$Day01$calcFuel(mass);
	if (!_v0) {
		return 0;
	} else {
		var fuel = _v0;
		return $author$project$Solvers$Day01$sumFuel(
			_List_fromArray(
				[
					fuel,
					$author$project$Solvers$Day01$calcFuelInclusive(
					$author$project$Solvers$Day01$calcMassOfFuel(fuel))
				]));
	}
};
var $author$project$Solvers$Day01$fuelRequiredIncludingAddedFuelMass = A2(
	$elm$core$Basics$composeR,
	$elm$core$List$map($author$project$Solvers$Day01$calcFuelInclusive),
	$author$project$Solvers$Day01$sumFuel);
var $author$project$Solvers$Day01$partTwo = _Utils_Tuple2(
	'Day 01, Part Two',
	$author$project$Lib$Solver$make(
		A2(
			$elm$core$Basics$composeR,
				...
				return _Utils_update(
					model,
					{
						K: A2(
							$elm$core$Maybe$map,
							function (a) {
								return _Utils_Tuple2(key, a);
							},
							A2($author$project$Lib$Solver$get, key, $author$project$Main$solvers))
					});
			default:
				var _v1 = model.K;
				if (_v1.$ === 1) {
					return _Utils_update(
						model,
						{
							J: $elm$core$Result$Err('Select a solver to run')
						});
				} else {
					var _v2 = _v1.a;
					var solver = _v2.b;
					return _Utils_update(
						model,
						{
							J: A2($author$project$Lib$Solver$run, solver, model.P)
						});
				}
		}
	});
...
var $author$project$Main$OnSolverSelect = function (a) {
	return {$: 1, a: a};
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('Wrapper_Input')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								A2($elm$core$Basics$composeL, $author$project$Main$OnInput, $author$project$Lib$Input$fromString)),
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('Wrapper_Solvers')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onInput($author$project$Main$OnSolverSelect)
							]),
						A2(
							$elm$core$List$cons,
							A2(
							...
							A2(
								$author$project$Lib$Solver$map,
								$author$project$Main$viewSolverOption(model.K),
								$author$project$Main$solvers))),
						A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('Wrapper_Output')
					]),
				_List_fromArray(
					[
						function () {
						...
						if (_v0.$ === 1) {
							...
							return A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('Output_Error')
									]),
								_List_fromArray(
									[
										A2(
							...
							if (_v0.a === '') {
								...
								return A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('Output_Success')
										]),
									_List_fromArray(
										[
											A2(
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		a6: $elm$core$Basics$always($author$project$Main$init),
		bn: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		br: F2(
			function (a, b) {
				return _Utils_Tuple2(
					A2($author$project$Main$update, a, b),
					$elm$core$Platform$Cmd$none);
			}),
		bs: $author$project$Main$view
	});
